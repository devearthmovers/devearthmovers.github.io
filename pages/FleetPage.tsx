                 ...
                 <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                     <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                        <div className="relative h-96">
                            <img src="https://images.unsplash.com/photo-1621997369-90637492062b?q=80&w=800&auto=format&fit=crop" alt="Equipment Maintenance" className="w-full h-full object-cover rounded-lg shadow-xl"/>
                        </div>
                        <div>
